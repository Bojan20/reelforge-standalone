...
//!
//! Modular organization (Phase 1 - W2 decomposition):
//! - api_engine.rs   → ENGINE LIFECYCLE
//! - api_transport.rs → TRANSPORT
...
// Engine lifecycle (init, shutdown, status)
pub use crate::api_engine::*;

// Transport control (play, stop, pause, seek, loop, tempo)
pub use crate::api_transport::*;

// Real-time metering (peaks, LUFS, CPU, correlation)
pub use crate::api_metering::*;

// Mixer (track volume, pan, mute, solo, bus routing)
