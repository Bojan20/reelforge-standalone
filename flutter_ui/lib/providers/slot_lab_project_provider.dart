...
class SlotLabProjectProvider extends ChangeNotifier {
  ...
  static String? _resolveStageFromFilename(String base, String full) {
    const aliases = <String, String>{
      ...
      // Big Win tier level-up (fires on each tier start during tier progression)
      ...
      // ── Free Spins END music (MUSIC_FS_END) ──
      ...
      // ── Free Spins LOOP music (MUSIC_FS_L1) ──
      ...
      'freespins_music_loop': 'music_fs_l1', 'free_spins_music_loop': 'music_fs_l1',
      'freespin_music_loop': 'music_fs_l1', 'free_spin_music_loop': 'music_fs_l1',
      'freespinmusic': 'music_fs_l1', 'freespinsmusic': 'music_fs_l1',
      'freespinsmusicloop': 'music_fs_l1', 'freespinmusicloop': 'music_fs_l1',
      ...
      'feature_music_loop': 'music_fs_l1',
      // ── Free Spins START / intro SFX (FS_HOLD_INTRO) ──
      ...
      'free_spin_intro': 'fs_hold_intro', 'free_spins_intro': 'fs_hold_intro',
      'freespinstart': 'fs_hold_intro', 'freespinsstart': 'fs_hold_intro',
      'freespinintro': 'fs_hold_intro', 'freespinsintro': 'fs_hold_intro',
      // hold / holding variants
      'fs_hold': 'fs_hold_intro', 'fs_holding': 'fs_hold_intro',
      'freespin_hold': 'fs_hold_intro', 'freespins_hold': 'fs_hold_intro',
      'free_spin_hold': 'fs_hold_intro', 'free_spins_hold': 'fs_hold_intro',
      'freespin_holding': 'fs_hold_intro', 'freespins_holding': 'fs_hold_intro',
      'free_spin_holding': 'fs_hold_intro', 'free_spins_holding': 'fs_hold_intro',
      'freespinhold': 'fs_hold_intro', 'freespinshold': 'fs_hold_intro',
      'freespinholding': 'fs_hold_intro', 'freespinsholding': 'fs_hold_intro',
      'fs_hold_loop': 'fs_hold_intro', 'fs_holding_loop': 'fs_hold_intro',
      'freespin_hold_loop': 'fs_hold_intro', 'freespins_hold_loop': 'fs_hold_intro',
      'free_spin_hold_loop': 'fs_hold_intro', 'free_spins_hold_loop': 'fs_hold_intro',
