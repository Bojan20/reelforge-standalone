...
String generateEventName(String stage) {
  ...
  final customNames = {
    ...
    'WILD_LAND_1': 'onWildLand1',
    'WILD_LAND_2': 'onWildLand2',
    'WILD_LAND_3': 'onWildLand3',
    'WILD_LAND_4': 'onWildLand4',
    'WILD_LAND_5': 'onWildLand5',
    'WILD_EXPAND': 'onWildExpand',
    'WILD_STACK': 'onWildStack',
    'SCATTER_LAND': 'onScatterLand',
    'BONUS_LAND': 'onBonusLand',
    ...
    'BIG_WIN_TICK_START': 'onBigWinTickStart',
    'BIG_WIN_TICK_END': 'onBigWinTickEnd',
    'COIN_SHOWER_START': 'onCoinShowerStart',
    'COIN_SHOWER_END': 'onCoinShowerEnd',
    ...
    // Free Spins
    'FS_HOLD_INTRO': 'onFsHoldIntro',
    'FS_HOLD_OUTRO': 'onFsHoldOutro',
    'FS_START': 'onFsStart',
    'FS_SPIN_START': 'onFsSpinStart',
    'FS_SPIN_END': 'onFsSpinEnd',
    'FS_WIN': 'onFsWin',
    'FS_SCATTER_LAND': 'onFsScatterLand',
    'FS_SCATTER_LAND_R1': 'onFsScatterLandR1',
    'FS_SCATTER_LAND_R2': 'onFsScatterLandR2',
    'FS_SCATTER_LAND_R3': 'onFsScatterLandR3',
    'FS_SCATTER_LAND_R4': 'onFsScatterLandR4',
    'FS_SCATTER_LAND_R5': 'onFsScatterLandR5',
    'FS_STICKY_WILD': 'onFsStickyWild',
    'FS_EXPANDING_WILD': 'onFsExpandingWild',
    'FS_MULTIPLIER_UP': 'onFsMultiplierUp',
    'FS_RETRIGGER': 'onFsRetrigger',
    'FS_RETRIGGER_3': 'onFsRetrigger3',
...
class StageGroupService {
  ...
  static final Map<String, String> _aliasMap = {
    ...
    // Symbol wins (generic + per-symbol)
    'symbol_highlight': 'SYMBOL_WIN',
    'win_highlight': 'SYMBOL_WIN',
    'sfx_symbol_highlight': 'SYMBOL_WIN',
    'sym_win': 'SYMBOL_WIN',
    'sym_highlight': 'SYMBOL_WIN',
    'sfx_hp1_win': 'HP1_WIN',
    'sfx_hp2_win': 'HP2_WIN',
    'sfx_hp3_win': 'HP3_WIN',
    'sfx_hp4_win': 'HP4_WIN',
    ...
    'sfx_lp5_win': 'LP5_WIN',
    'sfx_lp6_win': 'LP6_WIN',
    'sfx_wild_win': 'WILD_WIN',
    'sfx_scatter_highlight': 'SCATTER_WIN',
    'sfx_bonus_win': 'BONUS_WIN',
    'hp1_win': 'HP1_WIN',
    'hp2_win': 'HP2_WIN',
    'hp3_win': 'HP3_WIN',
    'hp4_win': 'HP4_WIN',
    ...
    'lp6_win': 'LP6_WIN',
    'wild_win': 'WILD_WIN',
    'scatter_highlight': 'SCATTER_WIN',
    'bonus_sym_win': 'BONUS_WIN',
    ...
    'wild_land_1': 'WILD_LAND_1',
    'wild_land_2': 'WILD_LAND_2',
    'wild_land_3': 'WILD_LAND_3',
    'wild_land_4': 'WILD_LAND_4',
    'wild_land_5': 'WILD_LAND_5',
    ...
    'big_win_coins': 'COIN_SHOWER_START',
  ...
  static final Map<StageGroup, List<_StageDefinition>> _stageDefinitions = {
    ...
    StageGroup.wins: [
      ...
      _StageDefinition(
        stage: 'COIN_SHOWER_START',
        keywords: ['coin', 'shower', 'coins', 'rain'],
        requiredKeywords: ['coin'],
        suffixes: ['_coins', '_shower'],
        priority: 90,
      ),
      _StageDefinition(
        stage: 'BIG_WIN_TICK_START',
        keywords: ['big', 'win', 'tick', 'rollup'],
        requiredKeywords: ['tick'],
        suffixes: ['_tick', '_rollup'],
        priority: 89,
      ),
      _StageDefinition(
        stage: 'WIN_FANFARE',
    ...
    StageGroup.musicAndFeatures: [
      ...
      _StageDefinition(
        stage: 'FS_HOLD_INTRO',
        keywords: ['freespin', 'free', 'spin', 'fs', 'trigger', 'hold', 'intro'],
        suffixes: ['_trigger', '_hold_intro'],
        priority: 92,
      ),
      _StageDefinition(
        stage: 'FS_START',
