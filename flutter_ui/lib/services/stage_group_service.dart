...
class StageGroupService {
  ...
  static const Map<String, String> _aliasMap = {
    ...
    // ═══════════════════════════════════════════════════════════════════
    // WIN — direct aliases (all common filename patterns)
    // ═══════════════════════════════════════════════════════════════════
    'quick_win': 'WIN_SMALL',
    'small_win': 'WIN_SMALL',
    'win_small': 'WIN_SMALL',
    'sfx_win_small': 'WIN_SMALL',
    'normal_win': 'WIN_MEDIUM',
    'medium_win': 'WIN_MEDIUM',
    'win_medium': 'WIN_MEDIUM',
    'sfx_win_medium': 'WIN_MEDIUM',
    'big_win': 'WIN_BIG',
    'win_big': 'WIN_BIG',
    'sfx_win_big': 'WIN_BIG',
    'mega_win': 'WIN_MEGA',
    'win_mega': 'WIN_MEGA',
    'sfx_win_mega': 'WIN_MEGA',
    'epic_win': 'WIN_EPIC',
    'win_epic': 'WIN_EPIC',
    'sfx_win_epic': 'WIN_EPIC',
    'ultra_win': 'WIN_ULTRA',
    'win_ultra': 'WIN_ULTRA',
    'sfx_win_ultra': 'WIN_ULTRA',
    'super_win': 'WIN_EPIC',
    'max_win': 'WIN_ULTRA',
    'no_win': 'NO_WIN',
    'nowin': 'NO_WIN',
