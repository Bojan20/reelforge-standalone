...
_MigrationResult _migrateV4toV5(Map<String, dynamic> data) {
  ...
  if (!data.containsKey('stage_definitions')) {
    data['stage_definitions'] = {
      'canonical_stages': [
        'UI_SPIN_PRESS', 'SPIN_END', 'REEL_SPIN_LOOP',
        ...
        'WIN_PRESENT', 'WIN_LINE_SHOW', 'WIN_LINE_HIDE', 'PAYLINE_HIGHLIGHT',
        'WIN_SYMBOL_HIGHLIGHT', 'WIN_SYMBOL_HIGHLIGHT_HP1', 'WIN_SYMBOL_HIGHLIGHT_HP2',
        'WIN_SYMBOL_HIGHLIGHT_HP3', 'WIN_SYMBOL_HIGHLIGHT_HP4',
        'WIN_SYMBOL_HIGHLIGHT_LP1', 'WIN_SYMBOL_HIGHLIGHT_LP2', 'WIN_SYMBOL_HIGHLIGHT_LP3',
        'WIN_SYMBOL_HIGHLIGHT_LP4', 'WIN_SYMBOL_HIGHLIGHT_LP5', 'WIN_SYMBOL_HIGHLIGHT_LP6',
        'WIN_SYMBOL_HIGHLIGHT_WILD', 'WIN_SYMBOL_HIGHLIGHT_SCATTER', 'WIN_SYMBOL_HIGHLIGHT_BONUS',
        'ROLLUP_START', 'ROLLUP_TICK', 'ROLLUP_END',
        'BIGWIN_TIER', 'COIN_SHOWER_START', 'COIN_SHOWER_END',
...
String _convertOldEventToStage(String oldType) {
  return switch (oldType.toLowerCase()) {
    ...
    'anticipation' || 'anticipation_start' || 'anticipation_on' => 'ANTICIPATION_TENSION',
    'anticipation_end' || 'anticipation_off' || 'anticipation_miss' => 'ANTICIPATION_MISS',
    ...
    'freespin' || 'freespin_start' || 'free_spin' => 'FS_START',
    'freespin_end' => 'FS_END',
