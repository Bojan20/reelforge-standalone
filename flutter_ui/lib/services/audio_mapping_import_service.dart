...
class AudioMappingImportService {
  ...
  static final Set<String> _allKnownStageIds = {
    ...
    'WIN_LINE_SHOW', 'WIN_LINE_HIDE', 'SYMBOL_WIN', 'WIN_LINE_CYCLE',
    'PAYLINE_HIGHLIGHT',
    'HP_WIN', 'HP1_WIN', 'HP2_WIN',
    'HP3_WIN', 'HP4_WIN',
    'MP_WIN', 'MP1_WIN', 'MP2_WIN',
    'MP3_WIN', 'MP4_WIN', 'MP5_WIN',
    'LP_WIN', 'LP1_WIN', 'LP2_WIN',
    'LP3_WIN', 'LP4_WIN', 'LP5_WIN',
    'LP6_WIN',
    'WILD_WIN', 'BONUS_WIN',
    'WIN_FANFARE',
    // Rollup
  ...
  static const Map<String, List<String>> _aliasPatterns = {
    ...
    'wild land': ['WILD_LAND'],
    'wild symbol': ['WILD_LAND'],
    'wild land 1': ['WILD_LAND_1'],
    'wild land 2': ['WILD_LAND_2'],
    'wild land 3': ['WILD_LAND_3'],
    'wild land 4': ['WILD_LAND_4'],
    'wild land 5': ['WILD_LAND_5'],
    'wild 1': ['WILD_LAND_1'],
    'wild 2': ['WILD_LAND_2'],
    'wild 3': ['WILD_LAND_3'],
    'wild 4': ['WILD_LAND_4'],
    ...
    'bonus land': ['BONUS_LAND'],
    'bonus symbol land': ['BONUS_LAND'],
    ...
    'win highlight': ['SYMBOL_WIN'],
    'symbol highlight': ['SYMBOL_WIN'],
    'sym highlight': ['SYMBOL_WIN'],
    ...
    'sym hp3 win': ['HP3_WIN'],
    'sym hp4 win': ['HP4_WIN'],
    'symbol hp1 win': ['HP1_WIN'],
    'symbol hp2 win': ['HP2_WIN'],
    'symbol hp3 win': ['HP3_WIN'],
    'symbol hp4 win': ['HP4_WIN'],
    'high pay 1 win': ['HP1_WIN'],
    'high pay 2 win': ['HP2_WIN'],
    'high pay 3 win': ['HP3_WIN'],
    'high pay 4 win': ['HP4_WIN'],
    'hp1 highlight': ['HP1_WIN'],
    'hp2 highlight': ['HP2_WIN'],
    'hp3 highlight': ['HP3_WIN'],
    'hp4 highlight': ['HP4_WIN'],
    'hp win': ['HP_WIN'],
    'high pay win': ['HP_WIN'],
    ...
    'sym mp4 win': ['MP4_WIN'],
    'sym mp5 win': ['MP5_WIN'],
    'medium pay 1 win': ['MP1_WIN'],
    'medium pay 2 win': ['MP2_WIN'],
    'medium pay 3 win': ['MP3_WIN'],
    'medium pay 4 win': ['MP4_WIN'],
    'medium pay 5 win': ['MP5_WIN'],
    'medium pay win': ['MP_WIN'],
    ...
    'sym lp5 win': ['LP5_WIN'],
    'sym lp6 win': ['LP6_WIN'],
    'symbol lp1 win': ['LP1_WIN'],
    'symbol lp2 win': ['LP2_WIN'],
    'symbol lp3 win': ['LP3_WIN'],
    'symbol lp4 win': ['LP4_WIN'],
    'symbol lp5 win': ['LP5_WIN'],
    'symbol lp6 win': ['LP6_WIN'],
    'low pay 1 win': ['LP1_WIN'],
    'low pay 2 win': ['LP2_WIN'],
    'low pay 3 win': ['LP3_WIN'],
    'low pay 4 win': ['LP4_WIN'],
    'low pay 5 win': ['LP5_WIN'],
    'low pay 6 win': ['LP6_WIN'],
    'lp win': ['LP_WIN'],
    'low pay win': ['LP_WIN'],

    // ─── Per-symbol win highlights — Special ─────────────────────────────
    'wild win': ['WILD_WIN'],
    'scatter highlight': ['SCATTER_WIN'],
    'bonus symbol win': ['BONUS_WIN'],
    'sym wild win': ['WILD_WIN'],
    'sym scatter win': ['SCATTER_WIN'],
    'sym bonus win': ['BONUS_WIN'],
