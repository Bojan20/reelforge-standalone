...
class BuiltInScenarios {
  ...
  static const bigWin = TestScenario(
    ...
    isBuiltIn: true,
    requiredStages: ['WIN_PRESENT_BIG', 'ROLLUP_START', 'ROLLUP_TICK', 'ROLLUP_END', 'COIN_SHOWER_START'],
    steps: [
      ScenarioStep(stageName: 'WIN_PRESENT_BIG', delayMs: 0, payload: {'winAmount': 500, 'winRatio': 10}),
      ScenarioStep(stageName: 'COIN_SHOWER_START', delayMs: 200),
  ...
  static const freeSpinsTrigger = TestScenario(
    ...
    isBuiltIn: true,
    requiredStages: ['FS_HOLD_INTRO', 'FS_START', 'FS_SPIN_START', 'FS_SPIN_END'],
    steps: [
      ScenarioStep(stageName: 'SCATTER_LAND', delayMs: 0, payload: {'count': 3}),
      ScenarioStep(stageName: 'FS_HOLD_INTRO', delayMs: 500),
      ScenarioStep(stageName: 'FS_HOLD_OUTRO', delayMs: 800),
      ScenarioStep(stageName: 'FS_START', delayMs: 1500),
