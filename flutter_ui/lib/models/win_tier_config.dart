...
///
/// Data-driven sistem za definisanje win tier-ova u slot igrama.
///
/// ## Tier System
///
/// **Regular Wins (< big win threshold):**
/// - WIN_LOW: < 1x bet (sub-bet win)
/// - WIN_EQUAL: = 1x bet (push)
/// - WIN_1 through WIN_5: regular wins
///
/// **Big Wins (threshold+):**
/// - BIG_WIN_TIER_1 through BIG_WIN_TIER_5
