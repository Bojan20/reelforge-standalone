...
enum SlotLabMusicSubTab { layers, segments, stingers, transitions, looping, beatGrid, tempoStates, gen }
...
extension SlotLabMusicSubTabX on SlotLabMusicSubTab {
  String get label => ['Layers', 'Segments', 'Stingers', 'Transitions', 'Looping', 'Beat Grid', 'Tempo States', 'GEN'][index];
  String get shortcut => ['Q', 'W', 'E', 'R', 'T', 'Y', 'U', 'I'][index];
  String get tooltip => [
    ...
    'GEN — local generative audio (prompt + arc → PCM via rf-generative)',
  ][index];
}
