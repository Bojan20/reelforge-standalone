...
enum SlotLabMonitorSubTab { timeline, energy, voice, spectral, fatigue, ail, neuro, debug, export, profiler, profilerAdv, evtDebug, resource, voiceStats }
...
extension SlotLabMonitorSubTabX on SlotLabMonitorSubTab {
  String get label => ['Timeline', 'Energy', 'Voice', 'Spectral', 'Fatigue', 'AIL', 'Neuro', 'Debug', 'Export', 'Profiler', 'Prof Adv', 'Evt Debug', 'Resources', 'Voice Stats'][index];
  String get shortcut => ['Q', 'W', 'E', 'R', 'T', 'Y', 'U', 'I', 'O', 'P', 'A', 'S', 'D', 'F'][index];
  String get tooltip => [
