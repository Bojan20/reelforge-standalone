              ...
              children: [
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _MiniChannelStrip(
                        ...
                        peakL: channel.peakL,
                        peakR: channel.peakR,
                        onVolumeChange: (v) => mixerProvider.setChannelVolume(channel.id, v),
                        onMuteToggle: () => mixerProvider.toggleChannelMute(channel.id),
                        onSoloToggle: () => mixerProvider.toggleChannelSolo(channel.id),
                      );
                    },
                  ),
                ),
                ...
                if (widget.showBuses && mixerProvider.buses.isNotEmpty) ...[
                  ...
                  ...mixerProvider.buses.map((bus) => _MiniChannelStrip(
                    ...
                    peakL: bus.peakL,
                    peakR: bus.peakR,
                    onVolumeChange: (v) => mixerProvider.setChannelVolume(bus.id, v),
                    onMuteToggle: () => mixerProvider.toggleChannelMute(bus.id),
                    onSoloToggle: () => mixerProvider.toggleChannelSolo(bus.id),
                    isBus: true,
                  )),
                ],
                ...
                if (widget.showMaster) ...[
                  ...
                  _MiniChannelStrip(
                    ...
                    onVolumeChange: (v) => mixerProvider.setMasterVolume(v),
                    onMuteToggle: () => mixerProvider.toggleChannelMute(mixerProvider.master.id),
                    isMaster: true,
                  ),
                ],
              ],
