...
// compatible — all `_` private classes remain in the same Dart library.
part 'slotlab/slotlab_painters.dart';
...
// ═══════════════════════════════════════════════════════════════════════════
// CUSTOM PAINTERS → slotlab/slotlab_painters.dart (part file)
// ═══════════════════════════════════════════════════════════════════════════
// _TimelinePainter, KeyboardShortcutsOverlay, _KeyboardShortcutsDialog,
// _FadeCurvePainter, _TlRulerPainter, _TlWaveformPainter,
// _TlGridPainter, _SpatialFieldPainter
