          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: FluxForgeTheme.bgVoid.withAlpha(77),
                    blurRadius: 20,
...
class _MorphPadPainter extends CustomPainter {
      ...
      if (preset != null) {
        final textPainter = TextPainter(
          text: TextSpan(
            ...
            style: TextStyle(
              color: FluxForgeTheme.textPrimary.withAlpha(isHovered ? 255 : 179),
  ...
  void _drawCursor(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(
      ...
      cursorSize,
      Paint()
        ..color = FluxForgeTheme.textPrimary.withAlpha(77)
        ..style = PaintingStyle.stroke
        ..strokeWidth = 2,
    );
    ...
    canvas.drawCircle(
      ...
      4,
      Paint()..color = FluxForgeTheme.textPrimary.withAlpha(128),
    );
    ...
    canvas.drawCircle(
      center,
      3,
      Paint()..color = FluxForgeTheme.textPrimary,
    );
  }
      ...
      if (preset != null) {
        ...
        final textPainter = TextPainter(
          text: TextSpan(
            text: preset.name,
            style: TextStyle(
              color: FluxForgeTheme.textPrimary.withAlpha(isHovered ? 230 : 128),
              fontSize: 10,
