...
class SlotPreviewWidgetState extends State<SlotPreviewWidget>
  ...
  void _onProviderUpdate() {
    ...
    if (!isPlaying && _isSpinning && !widget.provider.isReelsSpinning) {
      ...
      // UI_STOP_PRESS: stop button press SFX
      _ensureAudioRegistered('UI_STOP_PRESS');
      eventRegistry.triggerStage('UI_STOP_PRESS');
  ...
  void _executeSkipFadeOut() {
    ...
    final wasBigWin = _isInTierProgression;

    // Only stop music for big wins (BG music continues during normal wins)
    if (wasBigWin) {
