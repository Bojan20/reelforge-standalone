      ...
      child: Column(
        ...
        children: [
          ...
          _buildExpandableSection(
            ...
            [
              _buildScenarioButton('Tier 1 (10x)', 'bigwin_tier_1', {'multiplier': 15.0}),
              _buildScenarioButton('Tier 2 (30x)', 'bigwin_tier_2', {'multiplier': 35.0}),
              _buildScenarioButton('Tier 3 (75x)', 'bigwin_tier_3', {'multiplier': 75.0}),
              _buildScenarioButton('Tier 4 (150x)', 'bigwin_tier_4', {'multiplier': 150.0}),
              _buildScenarioButton('Tier 5 (300x+)', 'bigwin_tier_5', {'multiplier': 350.0}),
            ],
          ),
          const SizedBox(height: 6),
