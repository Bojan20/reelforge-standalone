        ...
        children: [
          ...
          if (node != null) ...[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: _categoryColor(node.category).withValues(alpha: 0.1),
          ...
          if (_inspector != null)
            GestureDetector(
              ...
              child: Icon(
                ...
                size: 12,
                color: _inspector!.pinned ? const Color(0xFF42A5F5) : Colors.white.withValues(alpha: 0.3),
              ),
            ),
        ],
      ),
        ...
        children: InspectorTab.values.map((tab) {
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: isActive == true ? Colors.white.withValues(alpha: 0.06) : Colors.transparent,
              ...
              child: Row(
                ...
                children: [
                  Icon(
                    ...
                    size: 10,
                    color: isActive == true ? Colors.white.withValues(alpha: 0.7) : Colors.white.withValues(alpha: 0.3),
                  ),
