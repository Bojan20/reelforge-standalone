...
class _SfxPipelineWizardState extends State<SfxPipelineWizard> {
  ...
  Widget _categoryBadge(SfxCategory cat) {
    ...
    const catColors = {
      ...
      SfxCategory.symbolLand: Color(0xFF6090FF),
      SfxCategory.symbolPreshow: Color(0xFF4070C0),
      SfxCategory.winCelebrations: FluxForgeTheme.accentGreen,
      SfxCategory.scatterLand: Color(0xFFFFA040),
      SfxCategory.wildLand: Color(0xFF40D080),
      SfxCategory.coinRollup: Color(0xFFE0C040),
      SfxCategory.payline: Color(0xFFC0A030),
      SfxCategory.screenEffect: Color(0xFFFF4060),
      ...
      SfxCategory.musicSpins: Color(0xFF60A0B0),
      SfxCategory.musicPicker: Color(0xFF7080A0),
