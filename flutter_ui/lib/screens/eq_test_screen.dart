...
class _EqTestScreenState extends State<EqTestScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: Icon(Icons.arrow_back, color: FluxForgeTheme.textSecondary),
  ...
  Widget _buildPultecInfo() {
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.lightbulb_outline, color: FluxForgeTheme.accentOrange, size: 20),
  ...
  Widget _buildApiInfo() {
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.music_note, color: FluxForgeTheme.accentGreen, size: 20),
          const SizedBox(width: 12),
          Expanded(
            child: Text(
  ...
  Widget _buildNeveInfo() {
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.auto_awesome, color: FluxForgeTheme.accentCyan, size: 20),
          const SizedBox(width: 12),
          Expanded(
            child: Text(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.touch_app, color: FluxForgeTheme.accentOrange, size: 20),
              const SizedBox(width: 12),
              Text(
