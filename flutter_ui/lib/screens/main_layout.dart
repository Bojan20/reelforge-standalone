...
class MainLayout extends StatefulWidget {
  ...
  final void Function(String channelId, double width)? onChannelWidthChange;
  ...
  void _showCommandPalette() {
    ...
    CommandRegistry.instance.registerDawCommands(
      ...
      onShowPackageManager: () {
        final controller = DawLowerZoneController.instance;
        controller.setEditSubTab(DawEditSubTab.packageManager);
        controller.expand();
      },
      onShowExtensionSdk: () {
        final controller = DawLowerZoneController.instance;
          ...
          child: Row(
            children: [
              ...
              LeftZone(
                ...
                onChannelWidthChange: widget.onChannelWidthChange,
    ...
    return Consumer<MixerProvider>(
      builder: (context, mixerProvider, _) {
        ...
        return ultimate.UltimateMixer(
          ...
          showInserts: true,
          showSends: true,
          onVolumeChange: (id, volume) => mixerProvider.setChannelVolumeWithUndo(id, volume),
          ...
          onMuteToggle: (id) => mixerProvider.toggleChannelMuteWithUndo(id),
